            ...
            <div className="cards__container">
                <div className="cards__wrapper">
                    <ul className="cards__items">
                        ...
                        path={{pathname: "https://github.com/rvpout/optical_Tachometer"}}
                        />
                        <CardItem 
                        src={pic6}
                        text="Multiplayer gorilla game. Coded with Java"
                        label='Gorilla game'
                        path={{pathname: "https://github.com/rvpout/Gorillagame"}}
                        />
                    </ul>
                    <ul className="cards__items">
                        <CardItem 
